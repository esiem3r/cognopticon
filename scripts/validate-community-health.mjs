...
requireText("docs/release-checklist.md", ["npm run check", "npm run validate:community", "npm run validate:daemon", "npm run validate:daemon-config", "public/workspace.json", "SECURITY.md", "SUPPORT.md", "independent reviewer"]);
